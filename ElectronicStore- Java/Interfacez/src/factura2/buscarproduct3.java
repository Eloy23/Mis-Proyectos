 ...
 * @author eloy
 */
public final class buscarproduct3 extends javax.swing.JInternalFrame {
   ...
   ResultSet r;
    public buscarproduct3() throws SQLException {
        initComponents();
 ...
 private void Selecionaarticulo(){
         ...
         DefaultTableModel modelo = (DefaultTableModel) factura2.jtableDetalle.getModel();
        ...
        String det=tb1.getValueAt(row[x], 2).toString();
         ...
         Object[]  dato=new Object[5];
            ...
            modelo.addRow(dato);
           factura2.jtableDetalle.setModel(modelo);
           factura2.jtableDetalle.editCellAt(row[x], 2);
           factura2.ajustarcolumnas();
            this.dispose();
        }
