...
public final class cobro2 extends javax.swing.JInternalFrame {
Connection con=null;
  Statement stmt=null;    
   ...
   String sql=null;
    ...
    public cobro2() throws SQLException {
        initComponents();
  CargarCB();
   ...
   Conexion cc = new Conexion();
    ...
    String cap="";
        ...
        try {
         ...
         Logger.getLogger(cobro2.class.getName()).log(Level.SEVERE, null, ex);
     }   
...
public void search(){
      try {
         ...
         buscarproduct2 z= new buscarproduct2();
         ...
         Logger.getLogger(cobro2.class.getName()).log(Level.SEVERE, null, e);
     }
    ...
    private void initComponents() {
        ...
        jButton6.setText("CALCULATE OPERAION");
