 ...
 * @author eloy
 */
public final class buscarproduct2 extends javax.swing.JInternalFrame {
   ...
   ResultSet r;
    public buscarproduct2() throws SQLException {
        initComponents();
 ...
 private void Selecionaarticulo(){
         ...
         DefaultTableModel modelo = (DefaultTableModel) cobro2.jtableDetalle.getModel();
        ...
        String det=tb1.getValueAt(row[x], 2).toString();
         ...
         Object[]  dato=new Object[5];
            ...
            modelo.addRow(dato);
           cobro2.jtableDetalle.setModel(modelo);
           cobro2.jtableDetalle.editCellAt(row[x], 2);
           cobro2.ajustarcolumnas();
            this.dispose();
         }
