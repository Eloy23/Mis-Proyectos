 ...
 * @author eloy
 */
public final class buscarproduct extends javax.swing.JInternalFrame {
   ...
   ResultSet r;
    public buscarproduct() throws SQLException {
        initComponents();
 ...
 private void Selecionaarticulo(){
        ...
        String det=tb1.getValueAt(row[x], 2).toString();
         String pre=tb1.getValueAt(row[x], 4).toString();
         ...
         Object[]  dato=new Object[5];
           ...
           factura.jtableDetalle.editCellAt(row[x], 2);
