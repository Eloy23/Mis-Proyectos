...
@endforeach
    ...
    <input type="text" class="form-control" value="{{$familiar->apellido_pat}}" id="apellido_pat" name="apellido_pat" placeholder="apellido_pat">
  	</div>

  	<div class="form-group">
    <label for="nombre">Apellido materno</label>
    <input type="text" class="form-control" value="{{$familiar->apellido_mat}}" id="apellido_mat" name="apellido_mat" placeholder="apellido_mat">
  	</div>
    ...
    <input type="text" class="form-control" value="{{$familiar->ingreso}}" id="ingreso" name="ingreso" placeholder="$1500">
  	</div>
