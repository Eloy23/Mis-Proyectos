...
<div class="container-fluid">
  ...
  <a class="navbar-brand" href="#">Gaya Vainilla y Especias</a>
   ...
   <!-- Authentication Links -->
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="{{route('addFamilia')}}">Agregar Familia del Productor</a>
       ...
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="{{route('visitas.mostrar')}}">Reporte de Visitas</a>
           <a class="dropdown-item" href="{{route('mapa.addYear')}}">Gráfica de producción por estado</a>
        </div>
      </li>
