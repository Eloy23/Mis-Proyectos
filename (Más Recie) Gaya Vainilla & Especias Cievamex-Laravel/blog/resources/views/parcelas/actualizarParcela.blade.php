		...
		@method('PUT')
		 @csrf
		  ...
		  <div class="form-group">
		    ...
		    <input type="number" class="form-control" value="{{$parcela->altitud}}" id="altitud" name="altitud">
		  </div>

		  <div class="form-group">
		    <label for="formGroupExampleInput">Superficie en producción(Ha)</label>
		    <input type="number" class="form-control" value="{{$parcela->ha}}" id="ha" name="ha">
		  </div>

		  <div class="form-group">
		    <label for="formGroupExampleInput">Pendiente (%)</label>
		    <input type="number" class="form-control" value="{{$parcela->pendiente}}" id="pendiente" name="pendiente">
		  </div>
